...
(define (problem rcll-production-durative-prob1)
	...
	(:init
		...
		(rs-inc ONE TWO)
		(rs-inc TWO THREE)
		(rs-ring-spec C-RS1 RING_BLUE ONE)
		(rs-ring-spec C-RS1 RING_ORANGE ZERO)
		(rs-ring-spec C-RS2 RING_GREEN TWO)
		...
		(wp-on-shelf cg1 C-CS2 LEFT)
		(wp-on-shelf cg2 C-CS2 MIDDLE)
		(wp-on-shelf cg3 C-CS2 RIGHT)
		(wp-on-shelf cb1 C-CS1 LEFT)
		(wp-on-shelf cb2 C-CS1 MIDDLE)
		(wp-on-shelf cb3 C-CS1 RIGHT)
		...
		(= (order-delivery-begin o5) 601)
		(= (order-delivery-begin o7) 713)
		(= (order-delivery-end o1) 900)
		(= (order-delivery-end o5) 727)
		(= (order-delivery-end o7) 846)
